...
export default function ToastContainer({ toasts }: { toasts: Toast[] }) {
    return (
        ...
        <div className="flex gap-2 flex-col justify-end mr-2 fixed inset-1 w-50 h-70 top-auto left-auto items-start transition-colors duration-150 ease-in-out overflow-hidden pointer-events-none bg-black/0 mask-[linear-gradient(to_top,black_50%,transparent_100%)]">
