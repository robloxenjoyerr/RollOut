    ...
    <>
      <div className="flex flex-col gap-8 h-120">
        ...
        <div className="flex flex-col items-center gap-4 w-full justify-center self-center ">
          <Shuffle
            className="self-center select-none text-7xl font-extrabold text-white drop-shadow-lg tracking-tight hover:scale-105 transition-all duration-300 ease-out"
            text="RollOut"
          ...
          <TextType
            ...
            className="text-(--accent-blue) text-xl font-bold select-none "
          />
        </div>
